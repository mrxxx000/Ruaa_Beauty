    ...
    <div className="page-coming-soon">
      ...
      <main>
        <section className="container" style={{ padding: '80px 0', textAlign: 'center' }}>
          <h1 style={{ fontSize: '2rem', marginBottom: 12 }}>Makeup — Coming soon</h1>
          <p style={{ color: '#666' }}>Our professional makeup services page is coming soon. Stay tuned for looks and booking info.</p>
        </section>
      </main>
